				    ...
				    if($this->verificarDatos("[a-zA-Z0-9$@.-]{7,100}",$clave)){
					    ...
					    if($check_usuario->rowCount()==1){
					    	...
					    	if($check_usuario['usuario_usuario']==$usuario && password_verify($clave,$check_usuario['usuario_clave'])){
								...
								$check_company=$this->ejecutarConsulta("SELECT * FROM empresa WHERE empresa_id='".$check_usuario['company_id']."'");
								...
								$_SESSION['time']=$check_usuario['time_finish'];
								$_SESSION['rol']=$check_usuario['usuario_rol'];
								$_SESSION['company']=$check_usuario['company_id'];
								$_SESSION['company_name']=$check_company['empresa_nombre'];
