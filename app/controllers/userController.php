<?php
	...
	class userController extends mainModel{
		...
		public function registrarUsuarioControlador(){
			...
			$company=$this->limpiarCadena($_POST['empresa_id']);


		    # Verificando campos obligatorios #
		    if($nombre=="" || $apellido=="" || $usuario=="" || $clave1=="" || $clave2=="" || $company==""){
		    	$alerta=[
					"tipo"=>"simple",
			...
			if($registrar_usuario->rowCount()==1){
				$alerta=[
					...
					"texto"=>"El usuario ".$nombre."  se registro con exito como ".$rol."",
					"icono"=>"success"
				];
			}else{
		...
		public function listarUsuarioControlador($pagina,$registros,$url,$busqueda){
			...
			if(isset($busqueda) && $busqueda!=""){
				...
				$consulta_datos="SELECT * FROM usuario WHERE ((usuario_id!='".$_SESSION['id']."' AND usuario_id!='1') AND (usuario_nombre LIKE '%$busqueda%' OR usuario_apellido LIKE '%$busqueda%' OR usuario_email LIKE '%$busqueda%' OR usuario_usuario LIKE '%$busqueda%' OR company_id LIKE '%$busqueda%')) ORDER BY usuario_nombre ASC LIMIT $inicio,$registros";
			...
			return $tabla;
				...
				/*----------  Controlador listar usuario  ----------*/
				public function listarUsuarioCompanyControlador($pagina,$registros,$url,$busqueda){
					...
					if(isset($busqueda) && $busqueda!=""){
						...
						$consulta_datos="SELECT * FROM usuario WHERE ((company_id LIKE '%$busqueda%')) ORDER BY usuario_nombre ASC LIMIT $inicio,$registros";
		...
		public function actualizarUsuarioControlador(){
		    ...
		    $clave2=$this->limpiarCadena($_POST['usuario_clave_2']);
			$rol=$this->limpiarCadena($_POST['usuario_rol']);
			$company=$this->limpiarCadena($_POST['company_id']);
