<?php
	...
	class categoryController extends mainModel{
		...
		public function registrarCategoriaControlador(){
		    ...
		    # Verificando nombre #
		    $check_nombre=$this->ejecutarConsulta("SELECT categoria_nombre FROM categoria WHERE company_id=".$empresa." AND categoria_nombre='$nombre'");
		...
		public function listarCategoriaControlador($pagina,$registros,$url,$busqueda){
			...
			if(isset($busqueda) && $busqueda!=""){
				...
				$consulta_datos="SELECT * FROM categoria WHERE (company_id=".$empresa.") AND (categoria_nombre LIKE '%$busqueda%' OR categoria_ubicacion LIKE '%$busqueda%') ORDER BY categoria_nombre ASC LIMIT $inicio,$registros";

				$consulta_total="SELECT COUNT(categoria_id) FROM categoria WHERE (company_id=".$empresa.") AND (categoria_nombre LIKE '%$busqueda%' OR categoria_ubicacion LIKE '%$busqueda%')";

			}else{

				$consulta_datos="SELECT * FROM categoria WHERE company_id=".$empresa." ORDER BY categoria_nombre ASC LIMIT $inicio,$registros";

				$consulta_total="SELECT COUNT(categoria_id) FROM categoria WHERE company_id=".$empresa."";
		...
		public function actualizarCategoriaControlador(){
			...
			# Verificando categoria #
		    $datos=$this->ejecutarConsulta("SELECT * FROM categoria WHERE company_id=".$empresa." AND categoria_id='$id'");
		    if($datos->rowCount()<=0){
		        $alerta=[
					"tipo"=>"simple",
					"titulo"=>"Ocurrió un error inesperado",
