<?php
	...
	class cashierController extends mainModel{
		...
		public function registrarCajaControlador(){
		    ...
		    $check_numero=$this->ejecutarConsulta("SELECT caja_numero FROM caja WHERE company_id = ".$_SESSION['company']." AND caja_numero='$numero'");
		    ...
		    $check_nombre=$this->ejecutarConsulta("SELECT caja_nombre FROM caja WHERE company_id=".$_SESSION['company']." AND caja_nombre='$nombre'");
		...
		public function listarCajaControlador($pagina,$registros,$url,$busqueda){
			...
			if(isset($busqueda) && $busqueda!=""){
				...
				$consulta_datos="SELECT * FROM caja WHERE company_id=".$_SESSION['company']." AND caja_numero LIKE '%$busqueda%' OR caja_nombre LIKE '%$busqueda%' ORDER BY caja_numero ASC LIMIT $inicio,$registros";

				$consulta_total="SELECT COUNT(caja_id) FROM caja WHERE company_id=".$_SESSION['company']." AND caja_numero LIKE '%$busqueda%' OR caja_nombre LIKE '%$busqueda%'";

			}else{

				$consulta_datos="SELECT * FROM caja WHERE company_id=".$_SESSION['company']." ORDER BY caja_numero ASC LIMIT $inicio,$registros";

				$consulta_total="SELECT COUNT(caja_id) FROM caja WHERE company_id=".$_SESSION['company'];
				...
				foreach($datos as $rows){
					$tabla.='
						<tr class="has-text-centered" >
							...
							<td>'.MONEDA_SIMBOLO.number_format($rows['caja_efectivo']).' '.MONEDA_NOMBRE.'</td>
			                <td>
