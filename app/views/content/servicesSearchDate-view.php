...
<div class="container is-fluid mb-6">
    ...
    <h2 class="subtitle"><i class="bi bi-calendar-event"></i> &nbsp; Buscar servicios realizados por Fecha</h2>
</div>
    ...
    <div class="columns">
        <div class="column">
            <form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/buscadorAjax.php" method="POST" autocomplete="off" >
                ...
                <div>
                    <p><span class="text-span">Desde:</span><span class="text-span">Hasta:</span></p>
                </div>
