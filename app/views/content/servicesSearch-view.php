<div class="container is-fluid mb-6">
    ...
    <h2 class="subtitle"><i class="fas fa-search"></i> &nbsp; Buscar servicios</h2>
</div>
            ...
            <form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/buscadorAjax.php" method="POST" autocomplete="off" >
                ...
                <div class="field is-grouped">
                    <p class="control is-expanded">
                        <input class="input is-rounded" type="text" name="txt_buscador" placeholder="¿Qué Servicio estas buscando?" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" id="text_buscador" maxlength="30" required >
                    </p>
                    <p class="control">
