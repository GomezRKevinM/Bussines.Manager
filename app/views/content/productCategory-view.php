    ...
    <div class="columns">
        ...
        <div class="column is-one-third">
            ...
            <?php
                ...
                $datos_categorias=$insProducto->seleccionarDatos("Normal","categoria WHERE company_id=".$_SESSION['company'],"*",0);
        ...
        <div class="column pb-6">
            ...
            <?php
                ...
                if($categoria->rowCount()>0){
                    ...
                    echo $insProducto->listarProductoCategoryControlador($url[2],10,$url[0],"",$url[1]);
                }else{
                    echo '
