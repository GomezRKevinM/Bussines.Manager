...
<div class="container is-fluid">
    <?php
        $check_empresa=$insLogin->seleccionarDatos("Normal","empresa WHERE empresa_id=".$_SESSION['company'],"*",0);
        ...
        <div class="column is-one-quarter">
            ...
            <?php } ?>
                ...
                <?php 
                        ...
                        $datos_cliente=$insLogin->seleccionarDatos("Normal","cliente WHERE cliente_id='1' AND company_id=".$_SESSION['company'],"*",0);
