...
<div class="container is-fluid mb-6">
    ...
    <h2 class="subtitle"><i class="fas fa-search-dollar fa-fw"></i> &nbsp; Buscar compra por código</h2>
</div>
<div class="container is-fluid">
            ...
            <form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/buscadorAjax.php" method="POST" autocomplete="off" >
                ...
                <div class="field is-grouped">
                    <p class="control is-expanded">
                        <input class="input is-rounded" type="text" name="txt_buscador" placeholder="Código de compra" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ\- ]{1,30}" maxlength="30" required >
                    </p>
                    <p class="control">
    ...
    <?php
            echo $insCompra->listarCompraControlador($url[1],15,$url[0],$_SESSION[$url[0]]);
