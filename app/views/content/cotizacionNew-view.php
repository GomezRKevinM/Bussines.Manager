<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle"><i class="bi bi-plus-circle-fill"></i></i> &nbsp; Nueva Cotización</h2>
</div>
    ...
    <div class="columns">
        ...
        <div class="column pb-6">
            ...
            <div class="notification is-info is-light mb-2 mt-2">
                <h4 class="has-text-centered has-text-weight-bold">Cotización realizada</h4>
                <p class="has-text-centered mb-2">La cotización se realizó con éxito. ¿Que desea hacer a continuación? </p>
                <br>
                <div class="container">
                    <div class="columns">
                        <div class="column has-text-centered">
                            <button type="button" class="button is-link is-light" onclick="print_ticket('<?php echo APP_URL."app/pdf/ticketC.php?code=".$_SESSION['venta_codigo_factura']; ?>')" >
                                <i class="fas fa-receipt fa-2x"></i> &nbsp;
                                Imprimir ticket de cotización
                            </buttona>
                        </div>
                        <div class="column has-text-centered">
                            <button type="button" class="button is-link is-light" onclick="print_invoice('<?php echo APP_URL."app/pdf/invoiceC.php?code=".$_SESSION['venta_codigo_factura']; ?>')" >
                                <i class="fas fa-file-invoice-dollar fa-2x"></i> &nbsp;
                                Imprimir factura de cotización
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="column is-one-quarter">
            <h2 class="title has-text-centered">Datos de la cotización</h2>
            <hr>
            ...
            <?php } ?>
                ...
                <div class="control mb-5">
                    <input class="input" type="hidden" name="venta_abono" id="venta_abono"  value="0.00" pattern="[0-9.]{1,25}" maxlength="25" readonly>
                </div>

                <div class="control mb-5">
                    <input class="input" type="hidden" id="venta_cambio" value="0.00" readonly>
                </div>

                <div class="control mb-5">
                        <input class="input" placeholder="Detalles o Comentarios" type="text" id="cotizacion_detalles" name="detalles">
                </div>
                ...
                <p class="has-text-centered">
                    <button type="submit" class="button is-info is-rounded"><i class="far fa-save"></i> &nbsp; Cotizar</button>
                </p>
                <?php } ?>
...
<script>
    ...
    function agregar_cliente(id){
        ...
        Swal.fire({
            ...
            text: "Se va a agregar este cliente para realizar una cotización",
            icon: 'question',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
    ...
    function remover_cliente(id){
        ...
        Swal.fire({
            ...
            text: "Se va a quitar el cliente seleccionado de la cotización",
            icon: 'question',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
