	...
	<div class="columns">
		<div class="column is-two-fifths">
			...
			<figure class="image mb-6">
                <img class="is-rounded is-photo" id="preview" src="<?php echo APP_URL; ?>app/views/fotos/<?php echo $datos['usuario_foto']; ?>">
			</figure>
			...
			<?php }else{ ?>
			<figure class="image mb-6">
			  	<img class="is-rounded is-photo" id="preview" src="<?php echo APP_URL; ?>app/views/fotos/default.png">
			</figure>
			<?php }?>
		</div>
			...
			<form class="mb-6 has-text-centered FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/usuarioAjax.php" method="POST" enctype="multipart/form-data" autocomplete="off" >
				...
				<div class="file has-name is-boxed is-justify-content-center mb-6">
				  	<label class="file-label">
						<input class="file-input" id="file_logo" type="file" name="usuario_foto" accept=".jpg, .png, .jpeg" >
						<span class="file-cta">
