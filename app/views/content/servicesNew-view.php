<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle"><i class="fas fa-cart-plus fa-fw"></i> &nbsp;Nueva venta de Servicios</h2>
</div>
    ...
    <div class="columns">
        ...
        <div class="column pb-6">
            ...
            <p class="has-text-centered pt-6 pb-6">
                <small>Para agregar servicios debe de digitar el código de barras en el campo "Código de barras" y luego presionar &nbsp; <strong class="is-uppercase" ><i class="far fa-check-circle"></i> &nbsp; Agregar servicio</strong>. También puede agregar el servicio mediante la opción &nbsp; <strong class="is-uppercase"><i class="fas fa-search"></i> &nbsp; Buscar servicio</strong>. Ademas puede escribir el código de barras y presionar la tecla <strong class="is-uppercase">enter</strong></small>
            </p>
            <form class="pt-6 pb-6" id="sale-barcode-form" autocomplete="off">
                <div class="columns">
                    <div class="column is-one-quarter">
                        <button type="button" class="button is-link is-light js-modal-trigger" data-target="modal-js-product" ><i class="fas fa-search"></i> &nbsp; Buscar servicio</button>
                    </div>
                    <div class="column">
            ...
            <div class="notification is-info is-light mb-2 mt-2">
                <h4 class="has-text-centered has-text-weight-bold">Venta de servicio realizada</h4>
                <p class="has-text-centered mb-2">La venta del servicio se realizó con éxito. ¿Que desea hacer a continuación? </p>
                <br>
                <div class="container">
                    <div class="columns">
                        <div class="column has-text-centered">
                            <button type="button" class="button is-link is-light" onclick="print_ticketS('<?php echo APP_URL."app/pdf/ticketS.php?code=".$_SESSION['venta_codigo_factura']; ?>')" >
                                <i class="fas fa-receipt fa-2x"></i> &nbsp;
                                Imprimir ticket de Servicio
                            </buttona>
                        </div>
                        <div class="column has-text-centered">
                            <button type="button" class="button is-link is-light" onclick="print_invoiceS('<?php echo APP_URL."app/pdf/invoiceS.php?code=".$_SESSION['venta_codigo_factura']; ?>')" >
                                <i class="fas fa-file-invoice-dollar fa-2x"></i> &nbsp;
                                Imprimir factura de Servicio
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="column is-one-quarter">
            <h2 class="title has-text-centered">Datos del servicio</h2>
            <hr>

            <?php if($_SESSION['venta_total']>0){ ?>
            <form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/serviceAjax.php" method="POST" autocomplete="off" name="formsale" >
            ...
            <?php } ?>
                ...
                <?php 
                        ...
                        $datos_cliente=$insLogin->seleccionarDatos("Normal","cliente WHERE company_id=".$empresa." AND cliente_id='1'","*",0);
...
<script>
    ...
    function agregar_producto(){
        ...
        if(codigo_producto!=""){
            ...
            fetch('<?php echo APP_URL; ?>app/ajax/serviceAjax.php',{
                method: 'POST',
                body: datos
            })
            ...
            Swal.fire({
                ...
                text: 'Debes de introducir el código del servicio',
    ...
    function buscar_codigo(){
        ...
        if(input_codigo!=""){
            ...
            Swal.fire({
                icon: 'error',
                title: 'Ocurrió un error inesperado',
                text: 'Debes de introducir el Nombre, Marca o Modelo del servicio',
                confirmButtonText: 'Aceptar'
            });
        }
    }
    ...
    function agregar_cliente(id){
        ...
        Swal.fire({
            ...
            text: "Se va a agregar este cliente para realizar un servicio",
            icon: 'question',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
    ...
    function remover_cliente(id){
        ...
        Swal.fire({
            ...
            text: "Se va a quitar el cliente seleccionado del servicio",
            icon: 'question',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
