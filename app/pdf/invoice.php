<?php
	...
	if($datos_venta->rowCount()==1){
		...
		$datos_empresa=$ins_venta->seleccionarDatos("Unico","empresa","empresa_id",$datos_venta['company_id']);
		...
		$pdf->SetTextColor(39,39,51);
		$pdf->MultiCell(0,9,iconv("UTF-8", "ISO-8859-1","*** Precios de productos no incluyen impuestos. Para poder realizar un reclamo o devolución debe de presentar esta factura ***"),0,'C',false);
