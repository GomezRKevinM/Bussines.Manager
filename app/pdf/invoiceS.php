<?php
	...
	if($datos_venta->rowCount()==1){
		...
		$pdf->Cell(100,10,iconv("UTF-8", "ISO-8859-1",strtoupper($datos_empresa['empresa_nombre'])),0,0,'L');
		...
		$pdf->SetTextColor(39,39,51);
		$pdf->Cell(35,7,iconv("UTF-8", "ISO-8859-1",strtoupper('Servicio Nro.')),0,0,'C');
		...
		$pdf->Output("I","Servicio_Nro".$datos_venta['venta_id'].".pdf",true);
